...
class PostFindRoom {
  ...
  String? districtName;
  String? wardsName;
  dynamic numberTenantCurrent;
  dynamic numberFindTenant;
  dynamic floor;
  int? province;
  int? district;
  int? wards;
  ...
  factory PostFindRoom.fromJson(Map<String, dynamic> json) => PostFindRoom(
      id: json["id"],
      userId: json["user_id"],
      ...
      moneyFrom:
          json['money_from'] == null ? null : json['money_from'].toDouble(),
      moneyTo: json['money_to'] == null ? null : json['money_to'].toDouble(),
