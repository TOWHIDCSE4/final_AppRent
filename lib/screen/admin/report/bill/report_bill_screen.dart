...
import 'package:gohomy/screen/admin/report/bill/report_bill_controller.dart';
...
class ReportBillScreen extends StatelessWidget {
  ...
  ReportBillScreen({
    ...
    controller = Get.put(
        ReportBillController(fromDateInput: fromDate, toDateInput: toDate));
    controller.getReportStaticBill();
  }

  final RefreshController _refreshController = RefreshController();

  late ReportBillController controller;
  @override
