...
class ReportBillController extends GetxController {
  ...
  var reportBill = ReportStaticBill().obs;

  ReportBillController({
    this.fromDateInput,
    this.toDateInput,
  }) {
  ...
  Future<void> getReportStaticBill() async {
    isLoading.value = true;
    try {
      var res =
          await RepositoryManager.reportRepository.getReportStaticBill(
