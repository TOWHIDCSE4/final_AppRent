...
class ReportContractController extends GetxController {
  ...
  var reportContract = ReportStaticContract().obs;

  ReportContractController({
    this.fromDateInput,
    this.toDateInput,
  }) {
  ...
  Future<void> getReportStaticContract() async {
    isLoading.value = true;
    try {
      var res =
          await RepositoryManager.reportRepository.getReportStaticContract(
        timeFrom: fromDay.value,
        timeTo: toDay.value,
      );

      reportContract(res!.data!);
