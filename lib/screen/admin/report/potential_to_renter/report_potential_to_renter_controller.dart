...
class ReportPotentialToRenterController extends GetxController {
  ...
  var reportPotentialToRenter = ReportPotentialToRenter().obs;

  ReportPotentialToRenterController({
    this.fromDateInput,
    this.toDateInput,
  }) {
  ...
  Future<void> getReportPotentialToRenter() async {
    isLoading.value = true;
    try {
      var res =
          await RepositoryManager.reportRepository.getReportPotentialToRenter(
        timeFrom: fromDay.value,
        timeTo: toDay.value,
      );

      reportPotentialToRenter(res!.data!);
