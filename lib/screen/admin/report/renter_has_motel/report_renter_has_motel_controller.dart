...
class ReportRenterHasMotelController extends GetxController {
  ...
  var reportPotential = ReportRenterHasMotel().obs;

  ReportRenterHasMotelController({
    this.fromDateInput,
    this.toDateInput,
  }) {
  ...
  Future<void> getReportRenterHasMotel() async {
    isLoading.value = true;
    try {
      var res =
          await RepositoryManager.reportRepository.getReportRenterHasMotel(
