...
import 'package:gohomy/screen/admin/report/renter_has_motel/report_renter_has_motel_controller.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

import '../../../../components/loading/loading_full_screen.dart';
import '../../../../utils/date_utils.dart';
import '../choose_time/choose_time_screen.dart';
import 'widget/chart_renter_has_motel.dart';

class ReportRenterHasMotelScreen extends StatelessWidget {
  DateTime? fromDate;
  DateTime? toDate;

  ReportRenterHasMotelScreen({
    this.fromDate,
    this.toDate,
  }) {
    controller = Get.put(
        ReportRenterHasMotelController(fromDateInput: fromDate, toDateInput: toDate));
    controller.getReportRenterHasMotel();
  }

  final RefreshController _refreshController = RefreshController();

  late ReportRenterHasMotelController controller;
  @override
