...
import 'package:gohomy/screen/owner/contract/add_contract/add_renter_sidekick_controller.dart';
...
class AddRenterSideKickScreen extends StatelessWidget {
   AddRenterSideKickScreen({super.key,required this.onSubmit,required this.renterInput}){
    controller = AddRenterSideKickController(renterInput: renterInput);
   }

   late AddRenterSideKickController controller;
   Function onSubmit;
    Renter renterInput;
  @override
