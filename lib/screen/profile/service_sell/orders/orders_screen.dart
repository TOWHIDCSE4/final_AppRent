...
import '../../../admin/service_sell/orders/widget/order_admin_item_widget.dart';
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return OrderAdminItemWidget(
                              order: e,
                              onTap: () {
                                  Get.to(()=>OrderHistoryDetailScreen(orderCode: e.orderCode!,))!.then((value) {
                                   tabController?.animateTo(0);
                                   ordersController.status.value = 0;
                                  ordersController.getAllOrder(
                                      isRefresh: true);
                                });
                              },
