...
import 'package:gohomy/screen/profile/service_sell/confirm_immediate/confirm_immediate_controller.dart';
...
import '../orders/detail/order_detail_screen.dart';
import '../orders/orders_screen.dart';


class ConfirmImmediateScreen extends StatelessWidget {
   ConfirmImmediateScreen({super.key,required this.cartItem}){
    controller = ConfirmImmediateController(cartItem: cartItem);
   }
  late ConfirmImmediateController controller;
  CartItem cartItem;
  @override
                  ...
                  () => InkWell(
                    onTap: () {
                      Get.to(() => ChooseInfoOrderScreen(
                            infoOrderReqInput:
                                controller.infoOrder.value,
                            confirm: (info) {
                              controller.infoOrder.value = info;
                              controller.infoOrder.refresh();
                    ...
                    child: Column(
                      children: [
                           ...
                           controller.infoOrder.value.addressDetail != null
                            ? Card(
                                child: Padding(
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                width: Get.width * 0.7,
                                                child: Text(
                                                  "${controller.infoOrder.value.name ?? "Chưa có tên"}  | ${controller.infoOrder.value.phoneNumber ?? "Chưa có số điện thoại"}",
                                                  maxLines: 2,
                                                ),
                                              ),
                                              if (controller.infoOrder
                                                          .value.email !=
                                                      null &&
                                              ...
                                              SizedBox(
                                                width: Get.width * 0.7,
                                                child: Text(
                                                  "${controller.infoOrder.value.wardsName ?? "Chưa có Phường/Xã"}, ${controller.infoOrder.value.districtName ?? "Chưa có Quận/Huyện"}, ${controller.infoOrder.value.provinceName ?? "Chưa có Tỉnh/Thành phố"}",
                                                  style: TextStyle(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    Text(SahaStringUtils().convertToMoney(
                            (cartItem.serviceSell?.price ?? 0)*(cartItem.quantity ?? 0))),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                  SahaStringUtils().convertToMoney(
                                      (cartItem.serviceSell?.price ?? 0)*(cartItem.quantity ?? 0) + 0),
                                  style: TextStyle(
                                      fontSize: 13, color: Colors.grey[800])),
                            ],
                          ),
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${SahaStringUtils().convertToMoney(
                            (cartItem.serviceSell?.price ?? 0)*(cartItem.quantity ?? 0))} VNĐ" ,
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      controller.orderImmediate(onSuccess: (order) {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          SahaStringUtils()
                              .convertToMoney(cartItem.serviceSell?.price ?? 0),
                          style: TextStyle(
